...
4) После первичного чтения мысленно пройди таблицу второй раз слева направо и сверху вниз и проверь, что ни один класс/урок не потерян, отдельно сверяя именно нижнюю часть таблицы.
5) Для каждого класса посчитай, сколько непустых ячеек у него в столбце, и убедись, что итоговое количество lessons для этого класса равно этому числу.
